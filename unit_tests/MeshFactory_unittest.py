...
class TestMeshFactory(unittest.TestCase):
    ...
    def test_Rectangle_Mesh(self):
        ...
        consistent_vhfs = Mesh._Check_Vtx2HalfFacets()
        ...
        self.assertEqual(consistent_sibhfs, True, "Should be True.")
        consistent_vhfs = Mesh_bcc._Check_Vtx2HalfFacets()
        self.assertEqual(consistent_vhfs, True, "Should be True.")
    ...
    def test_Box_Mesh(self):
        MF = MeshFactory()
        print(MF)
        #Simplex_Mesh_Of_Box(self, Pbll=[0.0, 0.0, 0.0], Ptur=[1.0, 1.0, 1.0],N0=10, N1=10, N2=10, UseBCC=False, FlatSides=False)
